<template>
  <div class="food-order">
    <div class="food-header">
      ...
      />
      <h2
        v-if="order[1][0].orderInformation.table !== 'take away'"
      >Bord: {{order[1][0].orderInformation.table}}</h2>
    ...
    <div class="comment-modal" v-if="showComment">
      <div class="filler" @click="toggleCommentModal" />
      <div class="modal-content">
        <img class="close-down-cross" :src="whiteCross" alt="Cancel icon" />
